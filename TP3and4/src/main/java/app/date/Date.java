...
public class Date {
     ...
     */
    public Date(int y, int m, int d) throws DateInvalide {
    ...
    */
    public void setYear(int y) throws DateInvalide {
    ...
    */
    public void setMois(int m) throws DateInvalide {
     ...
     */
    public void setJour(int d) throws DateInvalide {
    ...
    */
    public boolean before(Date uneDate) {
        return year < uneDate.year || (year == uneDate.year && month < uneDate.month)
